...
+ (UIButton *)newBackArrowNavButtonWithTarget:(id)target action:(SEL)action {
    return  [UIButton newcustomButtonWithTarget:target action:action normalImage:[UIImage imageNamed:@"back"] highlightedImage:[UIImage imageNamed:@"navigationbar_back"] size:CGSizeMake(45, 45)];
}
